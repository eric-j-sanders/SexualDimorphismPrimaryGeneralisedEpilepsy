...
# All datasets should be PLINK pgen format
...
plink2 --pfile $2 --make-pgen --out temp_${id}_step2_nodup2 --snps-only --allow-extra-chr --rm-dup exclude-all
...
bcftools isec -Oz -p temp_${id}_step8_int -c none -n=2 temp_${id}_step8_formerge1_prepared.vcf.gz temp_${id}_step8_formerge2_prepared.vcf.gz
...
awk 'NR==1 {print "#IID SEX"; next} {O1=$1"_"$2; print O1, $3}' temp_${id}_step8_formerge1_prepared.psam > temp_${id}_step9_finalsex.txt
awk 'NR>1 {O1=$1"_"$2; print O1, $3}' temp_${id}_step8_formerge2_prepared.psam >> temp_${id}_step9_finalsex.txt

# Take original two psam files, get new file with just new-format ID's and a status column
awk 'NR==1 {print "#IID STATUS"; next} {O1=$1"_"$2; print O1, $4}' temp_${id}_step8_formerge1_prepared.psam > temp_${id}_step9_finalstatus.txt
awk 'NR>1 {O1=$1"_"$2; print O1, $4}' temp_${id}_step8_formerge2_prepared.psam >> temp_${id}_step9_finalstatus.txt
